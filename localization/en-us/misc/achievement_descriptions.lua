...
return {
	...
	["ach_ovn_absolved_abandonment"]  = c_deck("Abandoned") .. "whilst having played a Royal Flush during a Finisher Boss Blind",
	["ach_ovn_checkered_changeling"]  = c_deck("Checkered") .. "whilst having played a Straight Spectrum during a Finisher Boss Blind",
	...
	["ach_ovn_plasma_plight"]         = c_deck("Plasma") .. "with a score at least 20 times greater than the Finisher Boss Blind requirement",
